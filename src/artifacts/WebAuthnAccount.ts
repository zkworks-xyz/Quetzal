...
export class WebAuthnAccountContract extends ContractBase {
  ...
  public methods!: {
    ...
    deserialize_and_validate_webauthn_witness: ((challenge: FieldLike, public_key_x: (bigint | number)[], public_key_y: (bigint | number)[]) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
