...
export function Alert({ message, onClose, alertType = AlertType.error }: AlertProps) {
  const colorClass = COLORS[alertType!];
  return (
    <div className={classNames('w-full', 'text-white', colorClass)}>
